...
<section class="page__controls">
    <h2>Config</h2>
    <button type="button" class="page__button" onclick="window.location.href='<?= url_to('Admin\Config::index') ?>'">Change</button>
    <button type="button" class="page__button" onclick="window.location.href='<?= url_to('Admin\Migration::index') ?>'">Migrate</button>
</section>
