...
<div class="page page--centered page--dark page--w30">
    <form class="form" method="post" action="<?= url_to('Authentication::resetSubmit') ?>">
        ...
        <input class="form__input" type="text" id="token" name="token" value="<?= set_value('token') ?>" required>

        <!-- user inputs -->
        <fieldset id="password-changer" class="form__group">

            <label class="form__label" for="password">New password</label>
            <input class="form__input" type="password" id="password" name="password" placeholder="**********" autocomplete="new-password" required>

            <label class="form__label" for="confirmPassword">Confirm new password</label>
            <input class="form__input" type="password" id="confirmPassword" name="confirmPassword" placeholder="**********" autocomplete="new-password" required>
